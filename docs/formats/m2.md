...
Bytecode layout:
```
[21]{group/channel: 8 bits}{device ID: 16 bits}{key/mode id: 8 bits}{amount: signed 8 bits/register num}{immediate/register toggle: 1 bit}{reset: 1 bit}{unused: 14 bits}
```
Human readable form:
```
