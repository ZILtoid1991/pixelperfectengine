...
Bytecode layout:
```
[42]{Register data source: 8 bits}{Device: 16 bits}{32 bits of padding}
[43]{00}{Device: 16 bits}{Register note or identifier source: 8 bits}{24 bits of padding}
[44]{Register data source: 8 bits}{Device: 16 bits}{Register note or identifier source: 8 bits}{24 bits of padding}
```
Human readable form:
```
$[[deviceID]]: [MIDI2.0 command with register number in data field]
;or
$[[deviceID]]: [MIDI2.0 command with register number in note or index field]
;or
$[[deviceID]]: [MIDI2.0 command with register number in note or index, and the data field]
```
