...
public class NewTileLayerDialog : Window {
	...
	public this(Editor editor){
		...
		label1 = new Label("Tile Width:"d, "label1", Coordinate(5, 22, 70, 39));
		addElement(label1);
		label2 = new Label("Tile Height:"d, "label2", Coordinate(5, 42, 70, 59));
		addElement(label2);
		textBox_TX = new TextBox("8"d, "textBox_TX", Coordinate(80, 21, 160, 39));
		addElement(textBox_TX);
		textBox_TY = new TextBox("8"d, "textBox_TY", Coordinate(80, 41, 160, 59));
		...
		checkBox_embed = new CheckBox("Embed as BASE64"d, "checkBox_embed", Coordinate(5, 102, 160, 118));
		addElement(checkBox_embed);
		label4 = new Label("Map Width:"d, "label4", Coordinate(5, 122, 70, 138));
		addElement(label4);
		label5 = new Label("Map Height:"d, "label5", Coordinate(5, 142, 70, 158));
		addElement(label5);
		textBox_MX = new TextBox("64"d, "textBox_MX", Coordinate(70, 121, 160, 139));
		addElement(textBox_MX);
		textBox_MY = new TextBox("64"d, "textBox_MY", Coordinate(70, 141, 160, 159));
		addElement(textBox_MY);
		label6 = new Label("Layer Name:", "label6", Coordinate(5, 162, 70, 178));
		addElement(label5);
		textBox_Name = new TextBox("64"d, "textBox_Name", Coordinate(70, 161, 160, 179));
